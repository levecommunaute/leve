...
export default function VideoPage(): JSX.Element {
  ...
  const handleSubmit=async()=>{
    ...
    const res=await fetch("/api/code/valider",{method:"POST",headers:{"Content-Type":"application/json","Authorization":"Bearer "+token},body:JSON.stringify({video_id:id,submitted_code:f1+"-"+f2+"-"+f3})});
